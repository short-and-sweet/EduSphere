...
INSERT IGNORE INTO `myapp_volunteerrecruitment` (`id`, `title`, `content`, `start_date`, `end_date`, `latitude`, `longitude`, `recruitment_completed`, `user_id`, `participant_count`) VALUES
	...
	(2, '수해 복구 작업', '- 집에 샤워기를 틀어놓고 나갔어요', '2024-04-24', '2024-04-26', 35.901306, 128.545902, 0, 4, 3),
	(3, '수해 복구 작업', '- 집에 샤워기를 틀어놓고 나갔어요', '2024-04-24', '2024-04-26', 35.901306, 128.545902, 0, 4, 3),
	(4, '수해 복구 작업', '- 집에 샤워기를 틀어놓고 나갔어요', '2024-04-24', '2024-04-26', 35.901306, 128.545902, 0, 4, 3),
	(5, '수해 복구 작업', '- 집에 샤워기를 틀어놓고 나갔어요', '2024-04-24', '2024-04-26', 35.901306, 128.545902, 0, 4, 3),
	(6, '동물 보호 활동', '- 야생 동물 구조를 위한 자원봉사 활동입니다.', '2024-04-28', '2024-04-30', 37.532600, 127.024612, 0, 5, 5),
	(7, '환경 정화 캠페인', '- 도시 곳곳에서 환경 정화 활동을 진행합니다.', '2024-05-01', '2024-05-03', 37.566536, 126.977966, 0, 6, 8),
	(8, '노인 복지봉사', '- 노인들을 위한 정기 방문 및 도움을 주는 활동입니다.', '2024-05-05', '2024-05-07', 35.179554, 129.075642, 0, 7, 4),
	(9, 'LGBT 복지봉사', '- LGBT인들을 위한 정기 방문 및 도움을 주는 활동입니다.', '2024-05-05', '2024-05-07', 35.149554, 129.275642, 0, 25, 4),
	(10, '장애인 지원 활동', '- 장애인들을 위한 문화체험 및 도움을 주는 자원봉사입니다.', '2024-05-10', '2024-05-12', 37.566759, 126.978413, 0, 8, 6),
	(11, '교육 지원 봉사', '- 어린이들을 위한 학교 방문 및 학업 지원 활동입니다.', '2024-05-15', '2024-05-17', 35.180681, 129.072905, 0, 9, 7),
	(12, '식품 나눔 봉사', '- 식료품을 필요로 하는 가정에 식품을 나눠주는 활동입니다.', '2024-05-20', '2024-05-22', 37.566619, 126.978417, 0, 10, 5),
	(13, '커뮤니티 정리 활동', '- 지역 커뮤니티를 위한 정리 및 개선 활동을 합니다.', '2024-05-25', '2024-05-27', 35.907757, 127.766922, 0, 11, 9),
	(14, '가난층 지원 봉사', '- 경제적으로 어려운 이웃들을 위한 자원봉사 활동입니다.', '2024-05-30', '2024-06-01', 37.566534, 126.977966, 0, 12, 4),
	(15, '동물 보호 활동', '- 유기동물을 위한 보호소 청소 및 도움을 주는 활동입니다.', '2024-06-05', '2024-06-07', 35.907757, 127.766922, 0, 13, 6),
	(16, '환경 보호 캠페인', '- 환경 보호를 위한 캠페인 활동을 합니다.', '2024-06-10', '2024-06-12', 37.566619, 126.978417, 0, 14, 8),
	(17, '음식물 쓰레기 수거', '- 음식물 쓰레기를 수거하고 재활용하는 활동을 합니다.', '2024-06-15', '2024-06-17', 35.907757, 127.766922, 0, 15, 7),
	(18, '어린이집 방문 봉사', '- 어린이집을 방문하여 어린이들을 위한 활동을 합니다.', '2024-06-20', '2024-06-22', 37.566534, 126.977966, 0, 16, 5),
	(19, '숲길 청소 봉사', '- 도시 근교의 숲길을 청소하는 활동입니다.', '2024-06-25', '2024-06-27', 37.566619, 126.978417, 0, 17, 4),
	(20, '노인 친구 만들기', '- 노인들을 위한 정기적인 방문 및 대화를 나누는 활동입니다.', '2024-06-30', '2024-07-02', 35.907757, 127.766922, 0, 18, 6),
	(21, '보호동물 관리 활동', '- 동물 보호소에서 보호동물들을 관리하고 도와주는 활동입니다.', '2024-07-05', '2024-07-07', 37.566534, 126.977966, 0, 19, 8),
	(22, '배식소 나눔 봉사', '- 배식소에서 음식을 나눠주는 활동입니다.', '2024-07-10', '2024-07-12', 37.566619, 126.978417, 0, 20, 5),
	(23, '환경 보호 캠페인', '- 지역의 환경 보호를 위한 캠페인 활동을 합니다.', '2024-07-15', '2024-07-17', 35.907757, 127.766922, 0, 21, 7),
	(24, '가정 양립 지원', '- 이중소득 가정을 위한 자원봉사 및 가정 양립 지원 활동입니다.', '2024-07-20', '2024-07-22', 37.566534, 126.977966, 0, 22, 6),
	(25, '희망나눔 자원봉사', '- 어려운 이웃들을 위한 희망나눔 자원봉사 활동입니다.', '2024-07-25', '2024-07-27', 37.566619, 126.978417, 0, 23, 4),
	(26, '동물 병원 돕기', '- 동물 병원에서 환자 동물들을 돕는 활동입니다.', '2024-07-30', '2024-08-01', 35.907757, 127.766922, 0, 24, 8),
	(27, '어린이집 활동 지원', '- 어린이집에서 어린이들을 위한 활동을 지원하는 자원봉사입니다.', '2024-08-05', '2024-08-07', 37.566534, 126.977966, 0, 25, 5),
	(28, '무료 급식소 봉사', '- 무료 급식소에서 음식을 나눠주는 자원봉사입니다.', '2024-08-10', '2024-08-12', 37.566619, 126.978417, 0, 26, 7),
	(29, '학교 돕기 봉사', '- 학교에서의 각종 활동을 도와주는 자원봉사입니다.', '2024-08-15', '2024-08-17', 35.907757, 127.766922, 0, 27, 6),
	(30, '환경 보호 캠페인', '- 도시 곳곳에서 환경 보호 활동을 진행합니다.', '2024-08-20', '2024-08-22', 37.566534, 126.977966, 0, 28, 4),
	(31, '장애인 도움 봉사', '- 장애인들을 위한 도움이 필요한 활동을 합니다.', '2024-08-25', '2024-08-27', 37.566619, 126.978417, 0, 29, 6),
	(32, '노인 산책 도우미', '- 노인들과 함께 산책을 나가는 활동을 합니다.', '2024-08-30', '2024-09-01', 35.907757, 127.766922, 0, 30, 5),
	(33, '어린이집 방문 봉사', '- 어린이집에서 어린이들을 돕는 활동을 합니다.', '2024-09-05', '2024-09-07', 37.566534, 126.977966, 0, 31, 7),
	(34, '쓰레기 수거 봉사', '- 도시의 쓰레기를 수거하는 활동을 합니다.', '2024-09-10', '2024-09-12', 37.566619, 126.978417, 0, 32, 8),
	(35, '보호소 도우미', '- 동물 보호소에서 보호 동물들을 돕는 활동입니다.', '2024-09-15', '2024-09-17', 35.907757, 127.766922, 0, 33, 6),
	(36, '길거리 나눔 봉사', '- 길거리에서 홈리스들에게 식사를 나눠주는 활동입니다.', '2024-09-20', '2024-09-22', 37.566534, 126.977966, 0, 34, 7),
	(37, '커뮤니티 정화 캠페인', '- 지역 커뮤니티를 정화하는 활동을 합니다.', '2024-09-25', '2024-09-27', 37.566619, 126.978417, 0, 35, 5),
	(38, '어린이날 축제 봉사', '- 어린이들을 위한 축제에서 활동합니다.', '2024-10-01', '2024-10-03', 35.907757, 127.766922, 0, 36, 8),
	(39, '가난층 돕기', '- 경제적으로 어려운 이웃을 돕는 봉사활동입니다.', '2024-10-05', '2024-10-07', 37.566534, 126.977966, 0, 37, 6);
